...
3. Automatic Loop Gain Control
   ...
   - when ¦Â < ¦Â<sub>OPT</sub>, ¦Â will increase. When ¦Â > ¦Â<sub>OPT</sub>, ¦Â will decrease.
   - the larger reference clock noise indeed deteriorates the output jitter, but it has little impact on ¦Â<sub>OPT</sub>.
